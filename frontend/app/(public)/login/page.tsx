                    ...
                    <div className="rounded-2xl border border-border bg-background p-6 shadow-sm sm:p-8">
                        ...
                        <form className="space-y-4">
                            ...
                            <div className="space-y-3">
                                <button type="button" className="flex w-full items-center justify-center gap-3 rounded-xl border border-border bg-card px-4 py-2 text-sm font-semibold transition hover:text-primary focus-visible:ring-2 focus-visible:ring-ring">
