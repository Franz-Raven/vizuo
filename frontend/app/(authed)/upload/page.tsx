              ...
              <div className="space-y-6">
                <div>
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span className="text-xs text-muted-foreground bg-muted px-3 py-1 rounded-full">Required</span>
                  </div>
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-2 text-center">Note: Video files are not allowed</p>
                  <input
                    ref={assetsInputRef}
                    type="file"
