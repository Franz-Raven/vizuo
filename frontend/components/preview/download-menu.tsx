  ...
  return (
    <div className="relative">
      <button
        ...
        className="inline-flex items-center gap-2 rounded-xl bg-primary px-4 py-2 text-sm font-semibold text-primary-foreground shadow-md shadow-primary/20 hover:bg-primary/90 transition"
      >
        <span>Download</span>
        <svg
          className="h-4 w-4"
