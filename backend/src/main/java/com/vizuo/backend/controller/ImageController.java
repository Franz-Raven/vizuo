...
public class ImageController {
    ...
    public ResponseEntity<?> uploadImage(
        ...
        try {
            // Temporary: use email from request param instead of authentication
            // TODO: Implement JWT authentication filter
            if (email == null || email.isEmpty()) {
                email = "test@example.com"; // Default user for testing
            }
            ...
            List<MultipartFile> attachmentFileList = attachmentFiles != null ? Arrays.asList(attachmentFiles) : List.of();
